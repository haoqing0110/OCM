...
func TestReconcile(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			managedClusteraddon: []runtime.Object{},
			clusterManagementAddon: []runtime.Object{
				addontesting.NewClusterManagementAddon("test", "", "").WithDefaultConfigs(addonv1beta1.AddOnConfig{
		...
		},
		{
			...
			clusterManagementAddon: []runtime.Object{
				...
				addontesting.NewClusterManagementAddon("test1", "", "").WithDefaultConfigs(addonv1beta1.AddOnConfig{
					ConfigGroupResource: addonv1beta1.ConfigGroupResource{
						Group:    utils.AddOnTemplateGVR.Group,
						Resource: utils.AddOnTemplateGVR.Resource,
					},
