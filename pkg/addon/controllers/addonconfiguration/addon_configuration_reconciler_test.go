...
func TestAddonConfigReconcile(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			clusterManagementAddon: addontesting.NewClusterManagementAddon("test", "", "").WithDefaultConfigs(addonapiv1beta1.AddOnConfig{
				ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
				ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test"},
			}).WithDefaultConfigReferences(addonapiv1beta1.DefaultConfigReference{
				ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
			...
			validateAddonActions: func(t *testing.T, actions []clienttesting.Action) {
				addontesting.AssertActions(t, actions, "patch", "patch")
				sort.Sort(byPatchName(actions))
				expectPatchConfigurationAction(t, actions[0], []addonapiv1beta1.ConfigReference{{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
					DesiredConfig: &addonapiv1beta1.ConfigSpecHash{
						ConfigReferent: addonapiv1beta1.ConfigReferent{Name: "test"},
						SpecHash:       "hash",
				...
				expectPatchConfigurationAction(t, actions[1], []addonapiv1beta1.ConfigReference{{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
					DesiredConfig: &addonapiv1beta1.ConfigSpecHash{
						ConfigReferent: addonapiv1beta1.ConfigReferent{Name: "test"},
						SpecHash:       "hash",
		...
		},
		{
			...
			}).WithPlacementStrategy(addonapiv1beta1.PlacementStrategy{
				PlacementRef:    addonapiv1beta1.PlacementRef{Name: "test-placement", Namespace: "default"},
				RolloutStrategy: clusterv1alpha1.RolloutStrategy{Type: clusterv1alpha1.All},
			}).WithInstallProgression(addonapiv1beta1.InstallProgression{
				PlacementRef: addonapiv1beta1.PlacementRef{Name: "test-placement", Namespace: "default"},
		...
		},
		{
			...
			clusterManagementAddon: addontesting.NewClusterManagementAddon("test", "", "").WithDefaultConfigs(
				addonapiv1beta1.AddOnConfig{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
					ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test"},
				},
				addonapiv1beta1.AddOnConfig{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Bar"},
					ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test"},
				},
				...
				ConfigReferences: []addonapiv1beta1.InstallConfigReference{
					...
					},
					{
						ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
						DesiredConfig: &addonapiv1beta1.ConfigSpecHash{
							ConfigReferent: addonapiv1beta1.ConfigReferent{Name: "test2"},
							SpecHash:       "hash2",
						},
					},
				},
		...
		},
		{
			...
			managedClusteraddon: []runtime.Object{
				newManagedClusterAddon("test", "cluster1", []addonapiv1beta1.AddOnConfig{
					{
						ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
						ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test2"},
					},
					{
						ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
						ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test3"},
					},
				}, nil, nil),
				addontesting.NewAddon("test", "cluster2"),
				// cluster3 already has configs synced to status before spec hash is updated
				newManagedClusterAddon("test", "cluster3", []addonapiv1beta1.AddOnConfig{
					{
						ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
						ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test2"},
					},
			...
			validateAddonActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				expectPatchConfigurationAction(t, actions[2], []addonapiv1beta1.ConfigReference{
					{
						ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Bar"},
						DesiredConfig: &addonapiv1beta1.ConfigSpecHash{
							ConfigReferent: addonapiv1beta1.ConfigReferent{Name: "test1"},
		...
		},
		{
			...
			managedClusteraddon: []runtime.Object{
				newManagedClusterAddon("test", "cluster1", []addonapiv1beta1.AddOnConfig{}, []addonapiv1beta1.ConfigReference{{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
					DesiredConfig: &addonapiv1beta1.ConfigSpecHash{
						ConfigReferent: addonapiv1beta1.ConfigReferent{Name: "test1"},
						SpecHash:       "hash1",
		...
		},
		{
			...
			clusterManagementAddon: addontesting.NewClusterManagementAddon("test", "", "").WithDefaultConfigs(addonapiv1beta1.AddOnConfig{
				...
				PlacementRef: addonapiv1beta1.PlacementRef{Name: "test-placement", Namespace: "default"},
				Configs: []addonapiv1beta1.AddOnConfig{addonapiv1beta1.AddOnConfig{
					ConfigGroupResource: addonapiv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
					ConfigReferent:      addonapiv1beta1.ConfigReferent{Name: "test1"}}},
				RolloutStrategy: clusterv1alpha1.RolloutStrategy{Type: clusterv1alpha1.All},
			}).WithInstallProgression(addonapiv1beta1.InstallProgression{
		...
		},
		{
			...
			clusterManagementAddon: addontesting.NewClusterManagementAddon("test", "", "").WithPlacementStrategy(addonapiv1beta1.PlacementStrategy{
				PlacementRef: addonapiv1beta1.PlacementRef{Name: "test-placement", Namespace: "default"},
		...
		},
		{
			...
			clusterManagementAddon: addontesting.NewClusterManagementAddon("test", "", "").WithPlacementStrategy(
				addonapiv1beta1.PlacementStrategy{
					PlacementRef: addonapiv1beta1.PlacementRef{Name: "test-placement", Namespace: "default"},
					RolloutStrategy: clusterv1alpha1.RolloutStrategy{
						Type: clusterv1alpha1.Progressive,
...
func newManagedClusterAddon(
	...
	configs []addonapiv1beta1.AddOnConfig,
	configStatus []addonapiv1beta1.ConfigReference,
...
func expectPatchConfigurationAction(t *testing.T, action clienttesting.Action, expected []addonapiv1beta1.ConfigReference) {
...
func expectPatchConditionAction(t *testing.T, action clienttesting.Action, expected metav1.ConditionStatus) {
	...
	actualCond := meta.FindStatusCondition(mca.Status.Conditions, addonapiv1beta1.ManagedClusterAddOnConditionConfigured)
