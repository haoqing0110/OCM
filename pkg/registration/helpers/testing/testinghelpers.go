...
func NewKubeconfig(clusterName, server, proxyURL, ca string, caData, key, cert []byte) []byte {
...
func NewManagedClusterAddons(name, namespace string, finalizers []string, deletionTimestamp *metav1.Time) *addonapiv1beta1.ManagedClusterAddOn {
