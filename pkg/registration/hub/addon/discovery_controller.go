...
func getAddOnLabelValue(addOn *addonapiv1beta1.ManagedClusterAddOn) string {
	availableCondition := meta.FindStatusCondition(addOn.Status.Conditions, addonapiv1beta1.ManagedClusterAddOnConditionAvailable)
